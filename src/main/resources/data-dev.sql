...
INSERT INTO authority_definitions (authority, description, category, enabled) VALUES
    ('ROLE_HQ_ADMIN', 'Headquarters Administrator', 'BUSINESS', true),
    ('ROLE_DISTRIBUTOR_ADMIN', 'Distributor Administrator', 'BUSINESS', true),
    ('ROLE_STORE_ADMIN', 'Store Administrator', 'BUSINESS', true),
    ('ROLE_CONSULTANT', 'Consultant Role', 'BUSINESS', true),
    ('ROLE_DISTRIBUTOR_EMPLOYEE', 'Distributor Employee', 'BUSINESS', true),
    -- 业务权限
    ('Vendors_Read', 'Read vendor information', 'VENDOR_MANAGEMENT', true),
    ('Vendors_Create', 'Create new vendors', 'VENDOR_MANAGEMENT', true),
    ('Vendors_Update', 'Update vendor information', 'VENDOR_MANAGEMENT', true),
    ('Vendors_Disable', 'Disable/Enable vendors', 'VENDOR_MANAGEMENT', true),
    ('Items_Read', 'Read item information', 'ITEM_MANAGEMENT', true),
    ('Items_Create', 'Create new items', 'ITEM_MANAGEMENT', true),
    ('Items_Update', 'Update item information', 'ITEM_MANAGEMENT', true),
    ('Items_Disable', 'Disable/Enable items', 'ITEM_MANAGEMENT', true),
    ('Warehouses_Read', 'Read warehouse information', 'WAREHOUSE_MANAGEMENT', true),
    ('Warehouses_Create', 'Create new warehouses', 'WAREHOUSE_MANAGEMENT', true),
    ('Warehouses_Update', 'Update warehouse information', 'WAREHOUSE_MANAGEMENT', true),
    ('Warehouses_Disable', 'Disable/Enable warehouses', 'WAREHOUSE_MANAGEMENT', true),
    ('Procurement_Read', 'Read procurement information', 'PROCUREMENT', true),
    ('Procurement_Create', 'Create procurement orders', 'PROCUREMENT', true),
    ('Procurement_Update', 'Update procurement orders', 'PROCUREMENT', true),
    ('Procurement_ApproveUpdates', 'Approve procurement updates', 'PROCUREMENT', true),
    ('Procurement_RequestUpdates', 'Request procurement updates', 'PROCUREMENT', true),
    ('Receiving_Read', 'Read receiving information', 'RECEIVING', true),
    ('Receiving_Create', 'Create receiving records', 'RECEIVING', true),
    ('Receiving_Update', 'Update receiving records', 'RECEIVING', true),
    ('Receiving_ApproveUpdates', 'Approve receiving updates', 'RECEIVING', true),
    ('Receiving_RequestUpdates', 'Request receiving updates', 'RECEIVING', true),
    ('QA_Read', 'Read QA information', 'QUALITY_ASSURANCE', true),
    ('QA_Create', 'Create QA records', 'QUALITY_ASSURANCE', true),
    ('Locations_Read', 'Read location information', 'LOCATION_MANAGEMENT', true),
    ('Locations_Create', 'Create new locations', 'LOCATION_MANAGEMENT', true),
    ('Locations_Update', 'Update location information', 'LOCATION_MANAGEMENT', true)
